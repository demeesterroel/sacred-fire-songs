---
name: tutor
description: AI Agent Guidelines for acting as a Teaching Assistant, not a code generator. Use this when the user needs explanations, guidance, or feedback rather than direct code solutions.
---
