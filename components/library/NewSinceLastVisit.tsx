      ...
      <div className="grid grid-cols-1 gap-2">
        {songs.map((song) => (
          <Link
            key={song.id}
            href={`/songs/${song.id}`}
            className="flex items-center gap-3 p-3 rounded-xl bg-white/60 dark:bg-gray-900/30 border border-emerald-500/10 hover:bg-emerald-500/5 hover:border-emerald-500/20 transition-all group"
          >
