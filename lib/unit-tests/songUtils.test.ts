...
describe('filterSongs', () => {
    const mockSongs = [
        ...
        { id: "2", title: "Aguita de la Vida", author: "Danit", songKey: "Em", color: "orange", createdAt: "2024-01-01", categories: [] },
        { id: "3", title: "Pachamama", author: "Medicine Family", songKey: "G", color: "yellow", createdAt: "2024-01-01", categories: [] },
    ];
