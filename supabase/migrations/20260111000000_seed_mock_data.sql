...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'expert@mock.com', '$2y$10$MockHashPassword............', now(), now(), now()),
...
BEGIN
    ...
    VALUES ('Victory Expert Song', 'Mock Expert', 'ES', '22222222-2222-2222-2222-222222222222')
    ...
    VALUES (new_song_id, 'Standard', '[G] This is a song [D] for the expert!', '22222222-2222-2222-2222-222222222222');
